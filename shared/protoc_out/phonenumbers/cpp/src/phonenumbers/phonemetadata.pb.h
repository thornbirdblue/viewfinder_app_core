...
class NumberFormat : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:i18n.phonenumbers.NumberFormat) */ {
 public:
  ...
  static const NumberFormat* internal_default_instance();
  ...
  void UnsafeMergeFrom(const NumberFormat& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_phonemetadata_2eproto_impl();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<NumberFormat> NumberFormat_default_instance_;
...
class PhoneNumberDesc : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:i18n.phonenumbers.PhoneNumberDesc) */ {
 public:
  ...
  static const PhoneNumberDesc* internal_default_instance();
  ...
  void UnsafeMergeFrom(const PhoneNumberDesc& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _arena_ptr_;
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<PhoneNumberDesc> PhoneNumberDesc_default_instance_;
...
class PhoneMetadata : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:i18n.phonenumbers.PhoneMetadata) */ {
 public:
  ...
  static const PhoneMetadata* internal_default_instance();
  ...
  void UnsafeMergeFrom(const PhoneMetadata& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _arena_ptr_;
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<PhoneMetadata> PhoneMetadata_default_instance_;
...
class PhoneMetadataCollection : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:i18n.phonenumbers.PhoneMetadataCollection) */ {
 public:
  ...
  static const PhoneMetadataCollection* internal_default_instance();
  ...
  void UnsafeMergeFrom(const PhoneMetadataCollection& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _arena_ptr_;
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<PhoneMetadataCollection> PhoneMetadataCollection_default_instance_;
